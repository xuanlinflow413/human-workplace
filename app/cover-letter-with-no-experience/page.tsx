...
export const metadata: Metadata = {
  ...
  description:
    "You do not need years of experience to write a cover letter that gets read. Here is how to lead with what you have actually done — even if it was not a job.",
  alternates: {
    canonical: "https://kindreply.co/cover-letter-with-no-experience/",
  },
  openGraph: {
    title: "How to Write a Cover Letter With No Experience",
    description:
      "Lead with proof of work, not a list of coursework. Real example + FAQ for first-time job seekers.",
    url: "https://kindreply.co/cover-letter-with-no-experience/",
    siteName: "KindReply",
    type: "article",
  },
  twitter: {
    ...
    title: "How to Write a Cover Letter With No Experience",
    description:
      "Lead with proof of work, not a list of coursework. Real example + FAQ.",
  },
};
...
const mistakes = [
  {
    title: "Apologizing for lack of experience",
    fix: "Do not say 'I know I do not have much experience.' Instead, show what you have built or fixed. Confidence attracts; apologies distract.",
  },
  {
    title: "Listing coursework instead of outcomes",
...
const faqs = [
  {
    q: "What if I have literally nothing to show?",
    a: "You have more than you think. Have you fixed a bug in an open-source project? Built a personal website? Written a technical blog post? Completed a challenging assignment? All of these count as proof of work.",
  },
  {
  ...
  },
  {
    ...
    a: "Stick to facts. 'I built X, it has Y users, it solved Z problem' is confident because it is verifiable. 'I am a fast learner' is arrogant because it is unprovable.",
  },
  {
    q: "Should I mention volunteer work or part-time jobs?",
    a: "Yes, if you can frame it around outcomes. 'Worked at a coffee shop' is weak. 'Trained three new hires and reduced order errors by 20%' is strong.",
  },
  {
      ...
      <section className="bg-[#F8F6F2] px-6 py-16 md:py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg text-[#6B6B6B] md:text-xl">
            You do not need years of experience to write a cover letter that
            gets read. Lead with what you have actually done.
          </p>
        </div>
      </section>

      <section className="mx-auto max-w-3xl px-6 py-16">
        <h2 className="text-2xl font-bold text-[#1A1A1A]">The Opening That Works</h2>
        <p className="mt-4 text-[#4A4A4A]">
          Most entry-level cover letters start with an apology. They list
      ...
      <section className="border-t border-[#E5E5E5] bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8 space-y-6">
            ...
            <div className="rounded-lg border border-[#E5E5E5] p-5">
              <h3 className="font-medium text-[#1A1A1A]">3. Write about what you learn</h3>
              <p className="mt-1 text-sm text-[#6B6B6B]">
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            ...
            <Link
              ...
              className="rounded-lg border border-[#E5E5E5] bg-white p-4 transition hover:border-[#1A1A1A]"
            >
              <p className="font-medium text-[#1A1A1A]">Career Change Cover Letter</p>
              <p className="mt-1 text-sm text-[#6B6B6B]">
            ...
            <Link
              ...
              className="rounded-lg border border-[#E5E5E5] bg-white p-4 transition hover:border-[#1A1A1A]"
            >
              <p className="font-medium text-[#1A1A1A]">Software Engineer Cover Letter</p>
              <p className="mt-1 text-sm text-[#6B6B6B]">
