  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        {/* Pro upgrade */}
        <section id="pricing" className="px-4 py-10 border-t border-border bg-muted/20">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    The tool picks out the role, company, and a relevant line to anchor the letter. It is a starting point — not a guarantee.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    A project, a result, or a skill. This keeps the letter specific.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Warm, confident, concise, or career change. Edit the draft before you send.
                  </p>
                </div>
              </div>
            </div>
